...
register_page(
    ...
    name="EOF/PLS Weighting - Methodology"
)
...
def make_diagram():
    ...
    add_box(x3, y_top, box_w, box_h, "EOF/PLS decomposition<br>4 EOFs/PLS & PCs kept<br>Variability modes")
    ...
    annots.append(dict(
        x=6, y=1.0,
        text=("The EOF/PLS modes are derived from ERA5.<br>"
...
layout = dbc.Container([
        ...
        html.H2("EOF + PLS Weighting Methodology",style={"textAlign": "center","color": "#003060","marginBottom": "40px"}),
